    ...
    return (
      <Card><CardContent className="py-12 text-center">
        ...
        <Button className="mt-4" size="sm" asChild>
          <Link to="/hop-dong/moi" search={{ assetId }}><Plus className="h-4 w-4 mr-1.5" />Tạo hợp đồng</Link>
        </Button>
      </CardContent></Card>
    );
  }
  ...
  return (
    <div className="space-y-2">
      <div className="flex justify-end">
        <Button size="sm" asChild><Link to="/hop-dong/moi" search={{ assetId }}><Plus className="h-4 w-4 mr-1.5" />Tạo hợp đồng</Link></Button>
      </div>
      {items.map((c) => (
            ...
            <CardContent className="p-4 flex items-center justify-between gap-3 flex-wrap">
              <div className="min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {c.assetUnitName && <span className="text-xs text-muted-foreground">{c.assetUnitName}</span>}
                </div>
              ...
              <div className="text-right">
                <div className="font-semibold">{formatVND(c.rentAmount)}</div>
